<header class="page-header">
            <div class="navbar">
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="hidden-xs"><a href="<?php echo site_url('logout')?>"><i class="glyphicon glyphicon-off"></i></a></li>
                </ul>
                <form id="search-form" class="navbar-form pull-right" role="search" method="get" action="<?php echo site_url($this->uri->segment(1).'/'.$this->uri->segment(2));?>">
                    <input type="search" class="form-control search-query" placeholder="Search..." name="q" autocomplete="off">
                </form>
                <!--
