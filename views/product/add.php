        ...
        <div class="row">
            <div class="col-md-6">
                <section class="widget">
                    ...
                    <div class="body">
                        <form class="form-horizontal" role="form" action="<?php echo site_url('product/save')?>" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" id="transparent-field" class="form-control input-transparent" placeholder="" name="price" autocomplete="off">
                                         <!--<span class="help-block">Director / Manager</span>-->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="catID" data-placeholder="Please select.." class="chzn-select select-block-level">
                                            ...
                                            <option value="<?php echo $cv->cms_product_category_id?>"><?php echo $cv->cms_product_category_name?></option>
                                            <?php endforeach?>
                                        </select>
                                    </div>
                                </div>
