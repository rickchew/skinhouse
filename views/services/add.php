...
<body>
    ...
    <div class="wrap">
        ...
        <h2 class="page-title">New Treatment <small></small></h2>
        <div class="row">
            <div class="col-md-6">
                <section class="widget">
                    <header>
                        <h4>
                            <i class="fa fa-align-left"></i>
                             Treatment Details <?php //print_r($category)?>
                        </h4>
                    ...
                    <div class="body">
                        <form class="form-horizontal" role="form" action="<?php echo site_url('services/save')?>" method="post">
                            <fieldset>
                                <legend class="section">&nbsp;</legend>
                                <div class="form-group">
                                    <label for="normal-field" class="col-sm-4 control-label">Treatment Name</label>
