...
<body>
    ...
    <div class="wrap">
        ...
        <h2 class="page-title">New Distributor <small></small></h2>
        <div class="row">
            <div class="col-md-6">
                <section class="widget">
                    ...
                    <div class="body">
                        <form class="form-horizontal" role="form" action="<?php echo site_url('category/save')?>" method="post">
                            <fieldset>
                                <legend class="section">&nbsp;</legend>
                                <div class="form-group">
                                    <label for="normal-field" class="col-sm-4 control-label">Category Name</label>
